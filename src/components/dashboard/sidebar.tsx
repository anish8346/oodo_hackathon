      ...
      >
        <div className="border-b border-slate-200 p-6">
          <div className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-[#0f766e] to-teal-400">
              ...
              <button
                ...
                className={cn(
                  ...
                  isActive
                    ...
                    : "text-slate-500 hover:bg-teal-50 hover:text-[#0f766e]"
                )}
              >
        ...
        <div className="border-t border-slate-200 p-4">
          <div className="flex items-center gap-3 rounded-xl px-4 py-2.5">
            ...
            <button
              type="button"
              aria-label="Log out"
              className="rounded-lg p-2 text-slate-500 transition-colors hover:bg-teal-50 hover:text-rose-600"
              onClick={() => {
                onLogout?.();
